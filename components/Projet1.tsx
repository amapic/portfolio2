      ...
      >
        <div className="relative bg-transparent flex flex-col md:flex-row justify-center items-center w-full h-full z-0">
          ...
          >
            ...
            <div
              ref={ref2}
              className="cursor-pointer relative w-1/2 mx-auto text-texteBlack inline-flex items-center justify-center    z-50 pb-4 pt-3 px-8 text-2xl font-bold hover:bg-yellow/90 transition-colors duration-200 shadow-lg hover:shadow-xl"
            >
              <a className="z-20 text-center mx-auto " href={url} target="_blank">Visitez le site</a>
          ...
          >
            <div className="flex flex-1 items-center justify-around pb-10">
              <div
                ref={ref3}
                className="relative h-full min-h-[450px] h-[70vh] md:h-[70vh]  lg:h-[60vh] w-full mx-auto text-texteBlack flex flex-col z-50   pt-3 px-8 text-2xl font-bold transition-colors duration-200 shadow-lg "
              >
                <div className="z-20 text-center mx-auto py-4">
                  <h3 className="pb-4">{titre}</h3>
                  <p>{description}</p>
                </div>
                <h3 className="text-center mx-auto z-20 py-8 w-full">
